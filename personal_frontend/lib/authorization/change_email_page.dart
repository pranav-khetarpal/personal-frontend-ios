...
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:personal_frontend/authorization/change_email_verification_page.dart';
import 'package:personal_frontend/components/my_large_button.dart';
import 'package:personal_frontend/components/my_square_textfield.dart';
import 'package:personal_frontend/helper/helper_functions.dart';
              ...
              MyLargeButton(
                ...
                onTap: () async {
                  ...
                  try {
                    ...
                    if (user != null) {
                      await user.verifyBeforeUpdateEmail(email);
                      displayMessageToUser("Verification email sent. Please verify your new email address.", context);

                      // Navigate to NewEmailVerificationPage
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NewEmailVerificationPage(
                            user: user,
                            newEmail: email,
                          ),
                        ),
                    ...
                    displayMessageToUser("Failed to update email: ${e.message}", context);
                  } catch (e) {
                    // handle any errors
                    displayMessageToUser("Failed to update email: $e", context);
                  }
