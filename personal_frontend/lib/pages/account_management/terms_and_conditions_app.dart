...
class TermsAndConditionsApp extends StatelessWidget {
  const TermsAndConditionsApp({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('App Terms and Conditions')),
      body: const Padding(
...
These terms and conditions outline the rules and regulations for the use of Market Gather.

By using this app we assume you accept these terms and conditions. Do not continue to use Market Gather if you do not agree to take all of the terms and conditions stated on this page.
...
If you are one of the organizations listed in paragraph 2 above and are interested in linking to our App, you must inform us by sending an e-mail to Market Gather. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our App, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
